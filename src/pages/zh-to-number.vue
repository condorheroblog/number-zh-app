  ...
  <div class="my-6 mr-5 flex flex-col gap-6">
    <label class="flex items-center justify-center gap-4">
      ...
      <div class="flex flex-1 rounded-md shadow-sm ring-1 ring-gray-300 ring-inset">
        <input v-model="source" type="text" name="input" autocomplete="false" class="flex-1 bg-transparent px-3 py-1.5 sm:text-sm placeholder:text-gray-400 sm:leading-6 focus:ring-0" :placeholder="t('enter-a-chinese-numeral')">
      </div>
    </label>
    ...
    <div class="flex items-center justify-center gap-4">
      ...
      <div class="flex flex-1 items-center gap-4">
        <label class="inline-flex gap-x-2">
          <input v-model="thousandsSeparator" :value="true" name="thousandsSeparator" type="radio" class="input-radio">
          <span class="text-sm">{{ t("yes") }}</span>
        </label>
        <label class="inline-flex gap-x-2">
          <input v-model="thousandsSeparator" :value="false" name="thousandsSeparator" type="radio" class="input-radio">
